class ConsoleApp {
    ...
    processCommand(command) {
        ...
        if (mainCommand === "palindrome") {
            if (this.checkIfPalindrome(commandArg)) {
                this.writeToConsole(`${commandArg} is a palindrome.`);
            } else {
                this.writeToConsole(`${commandArg} is not a palindrome.`);
            }
            return;
        }
        if (this.waitingForCommandData) {
            ...
            this.writeToConsole("palindrome - Check if a word or phrase is a palindrome.", false);
    ...
    checkIfPalindrome(str) {
        const formatedStr = str.toLowerCase().replace(/[^a-z]/g, "")
